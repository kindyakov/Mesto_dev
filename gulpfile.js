...
const mainTasks = gulp.series(video,
  gulp.parallel(copy,
    gulp.series(insertCriticalCss, html, genTemplatePages, genPages, htmlReplaceExtensionImg, js), // genTemplatePages, genPages,
    scss, images, php))

const devTasks = gulp.series(
  video,
  gulp.parallel(copy,
    gulp.series(generateHtmlData, insertCriticalCss, html, genTemplatePages, genPages), // genTemplatePages, genPages
    scss, js, images, php))
